...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      for (final Locale locale in locales) {
        ...
        final Text stringFragmentText = tester.widget(
          timeSelectorSeparatorFinder,
        );
        final double hourLeftOffset = tester
            .getTopLeft(dialHourControlFinder)
            .dx;
        final double minuteLeftOffset = tester
            .getTopLeft(dialMinuteControlFinder)
            .dx;
        final double stringFragmentLeftOffset = tester
            .getTopLeft(timeSelectorSeparatorFinder)
            .dx;

        if (locale == const Locale('en', 'US')) {
          final double dayPeriodLeftOffset = tester
              .getTopLeft(dayPeriodControlFinder)
              .dx;
    ...
    (WidgetTester tester) async {
      ...
      for (final Locale locale in locales) {
        ...
        final double hourLeftOffset = tester
            .getTopLeft(dialHourControlFinder)
            .dx;
        final double hourTopOffset = tester
            .getTopLeft(dialHourControlFinder)
            .dy;
        final double minuteLeftOffset = tester
            .getTopLeft(dialMinuteControlFinder)
        ...
        if (locale == const Locale('en', 'US')) {
          final double dayPeriodLeftOffset = tester
              .getTopLeft(dayPeriodControlFinder)
              .dx;
          final double dayPeriodTopOffset = tester
              .getTopLeft(dayPeriodControlFinder)
              .dy;
          expect(stringFragmentText.data, ':');
          expect(hourLeftOffset, lessThan(stringFragmentLeftOffset));
  ...
  testWidgets('Material2 - can localize input mode in all known formats', (
    ...
    for (final Locale locale in locales) {
      ...
      final double hourLeftOffset = tester
          .getTopLeft(inputHourControlFinder)
          .dx;
      final double minuteLeftOffset = tester
          .getTopLeft(inputMinuteControlFinder)
          .dx;
      final double stringFragmentLeftOffset = tester
          .getTopLeft(timeSelectorSeparatorFinder)
          .dx;
  ...
  testWidgets(
    'AM/PM buttons should be aligned to LTR in Hindi language - Portrait',
    (WidgetTester tester) async {
      ...
      final Offset amButtonPositionPortrait = tester.getCenter(
        amButtonPortrait,
      );
      final Offset pmButtonPositionPortrait = tester.getCenter(
        pmButtonPortrait,
      );
  ...
  // Regression test for https://github.com/flutter/flutter/issues/156565
  testWidgets(
    'AM/PM buttons should be aligned to LTR in Hindi language - Landscape',
    (WidgetTester tester) async {
      const Locale locale = Locale('hi', 'HI');
      ...
      final Offset amButtonPositionLandscape = tester.getCenter(
        amButtonLandscape,
      );
      final Offset pmButtonPositionLandscape = tester.getCenter(
        pmButtonLandscape,
      );
