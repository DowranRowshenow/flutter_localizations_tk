...
void main() {
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // (yjbanov): also test `HH.mm` (in_ID), `a h:mm` (ko_KR) and `HH:mm น.` (th_TH) when we have .arb files for them
      ...
      for (final Locale locale in locales) {
        ...
        final double minuteLeftOffset =
            tester.getTopLeft(minuteControlFinder).dx;
